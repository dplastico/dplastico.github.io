...
This is a nice challenge where you don’t have a free function, so you need to overflow and get a leak by overwriting the top chunk, forcing a previous chunk to be freed, leaking data, and then using FSOP to get RCE. Really nice heap challenge.
