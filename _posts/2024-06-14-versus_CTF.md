...
Interesting challenge. I ended up with a write-what-where by overwriting the return address, making it jump back to the beginning of the function so I could have infinite writes.
...
#========= exploit here ===================
#infinite bit flips by mod the address in cosmic_ray()
target = 0x4015aa
