...
```
We  can check the range in gdb as follows:
...
Thanks also to my study-buddies [s1kr10s](https://s1kr10s.github.io/), [Totoxx](https://tothoxx.github.io/), and Vicho, that always encourage me to write more.
