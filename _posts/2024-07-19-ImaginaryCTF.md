...
In this challenge, you can write to any address since a leak is provided. I overwrote the stdout struct to get a shell using FSOP.
...
def start():
    if args.GDB:
        return gdb.debug('./vuln_patched', gdbscript=gs)
    if args.REMOTE:
        return remote('127.0.0.1', 5555)
    else:
        return process('./vuln_patched')
r = start()
#========= exploit here ===================
